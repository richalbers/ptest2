...
{ 
	...
	//when lines are clicked on highlight them (future ones too)
	//Bad feature (hightlinged when links were clicked.  Disabled for now...
	/*
	$('#MainDisabled li, h1Disabled').live('click', function() {
		//if a link was clicked on, don't highlight it....
		//TODO
...
function ShowSlide(SlideNum)
{
	...
	$("#Main").fadeOut(speedMS, function() {
		$("#Main").html(aSlides[iCurrentSlide]).fadeIn(speedMS);
	});
